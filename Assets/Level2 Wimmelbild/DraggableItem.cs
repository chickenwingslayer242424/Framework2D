...
public class DraggableItem : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public TMP_Text associatedText; 
    ...
    private void Awake() // Zugriff erteilen
    {
        ...
        startPosition = transform.localPosition; // Speichern der Startposition
    }
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        if (canvasGroup != null)
        {
            ...
            startPosition = transform.localPosition; // speichert Startposition des Items
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        if (eventData.pointerEnter != null && eventData.pointerEnter.CompareTag("InventorySlot")) // wenn das Item in einen Slot gezogen wurde, passiert folgendes:
        {
            ...
            UIManager.Instance.MarkItemAsFound(associatedText); //Text wird durchgestrichen
        ...
        else
        {
            ...
            transform.localPosition = startPosition; //setzt Position des Items zurück
        }
